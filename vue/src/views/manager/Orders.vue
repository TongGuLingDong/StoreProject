  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="price" label="订单总价" show-overflow-tooltip>
          <template v-slot="scope">
            ￥{{scope.row.price}}
          </template>
        </el-table-column>
        ...
        <el-table-column label="操作" width="180" align="center">
          <template v-slot="scope">
            <el-button plain type="success" size="mini" v-if="scope.row.status === '待发货'" @click="updateStatus(scope.row,'待收货')">发货</el-button>
