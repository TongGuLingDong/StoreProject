  ...
  <div class="main-content">
    <div style="width: 60%;background-color: white;min-height: 1000px;margin:20px auto;border-radius: 20px">
      <div style="padding: 15px 20px">
        <el-row :gutter="20">
          <el-col :span="12">
            <img :src="goodsData.img" style="width: 100%;height: 400px;border-radius: 20px">
          </el-col>
          <el-col :span="12">
            ...
            <div style="margin-top: 20px;">
              <img src="@/assets/imgs/right.png" style="width: 80%;height: 130px;border-radius: 15px">
            </div>
            ...
            <div style="margin-top: 20px">
              ...
              <el-button type="info" @click="collect">收藏</el-button>
            </div>
          </el-col>
        </el-row>
      </div>
              ...
              <div style="margin-top: 20px" v-for="item in commentData">
                <div style="display: flex;">
                  <div style="width: 40px">
                    <img :src="item.userAvatar" style="height: 40px;width: 40px;border-radius: 50%">
                  </div>
